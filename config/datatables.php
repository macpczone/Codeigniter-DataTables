...
$config['datatables.action1'] = '<a href="{{example/read/@@}}" class="view-btn">VIEW</a>&nbsp;|&nbsp;<a href="{{example/update/@@}}" class="edit-btn">EDIT</a>&nbsp;|&nbsp;<a href="{{example/delete/@@}}" class="delete-btn">DELETE</a>';
